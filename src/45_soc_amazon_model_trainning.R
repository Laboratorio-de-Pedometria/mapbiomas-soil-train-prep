...
# Read Brazilian biomes shapefile
biome <- geobr::read_biomes()
biome <- biome[biome$code_biome == 1, ]
...
# Read data from disk
matrix_path <- "~/Insync/Earth Engine Exports/2024-12-01-organic-carbon-stock-gram-per-square-meter-filter-rep.csv"
...
original_name <- "-organic-carbon-stock-gram-per-square-meter.csv"
