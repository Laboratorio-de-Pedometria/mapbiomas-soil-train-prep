...
covars_names <- c(
  ...
  # "STONESOL", "STONY", "ORGANIC", "AHRZN", "BHRZN", "BHRZN_DENSE", "EHRZN", "DENSIC",
...
num_trees <- c(100, 200, 400, 800)[4]
mtry <- c(2, 4, 8, 16)[4]
min_node_size <- c(1, 2, 4, 8)[2]
max_depth <- c(10, 20, 30, 40)[3]
...
nrow(unique(soildata[, "id"])) # Result: 16994
nrow(soildata) # Result: 51152
